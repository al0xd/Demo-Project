...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: ITbe7eB3jNMGB/css
...
export const PlasmicButton__VariantProps = new Array<VariantPropType>("colors");
